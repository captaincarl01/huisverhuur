  ...
  return (
    <>
      ...
      <div style={{ maxWidth: "1140px", margin: "0 auto", padding: "1.5rem 2rem", height: "calc(100vh - 64px)", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "320px 1fr", flex: 1, minHeight: 0, background: "var(--white)", borderRadius: "12px", boxShadow: "0 4px 24px rgba(0,0,0,.08)", overflow: "hidden", border: "1px solid var(--fog)" }}>
